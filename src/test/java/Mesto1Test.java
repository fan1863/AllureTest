...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MjJlMWZiMWRjY2Q4YTAwM2RlMTEwMzIiLCJpYXQiOjE2NTQ2Njc1NTcsImV4cCI6MTY1NTI3MjM1N30.UQp95iyLZ1FrYMtW7CcJh0aXqFNxOR65EmT2rb1gcUk";
    ...
    public void addNewPhoto() {
        given()
                ...
                .body("{\"name\":\"Питер\",\"link\":\"https://code.s3.yandex.net/qa-automation-engineer/java/files/paid-track/sprint1/photoSelenium.jpg\"}") // Формируем тело запроса
